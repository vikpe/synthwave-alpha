...
set -U fish_color_comment {CYAN.hex} # comments like '# important'
...
set -U fish_color_escape {GREEN_DARK.hex} # character escapes like 'n' and 'x70'
...
set -U fish_pager_color_selected_background --background={BLACK_DARK.hex} # background of the selected completion
...
set -U fish_pager_color_selected_description {WHITE_DARK.hex} # description of the selected completion
